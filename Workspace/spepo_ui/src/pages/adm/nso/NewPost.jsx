...
const NewPost = () => {
    ...
    const handleChange = () =>{
        ...
        saveFileAPI(selectedFile).then(saveFileResponse => {
            ...
            const api ={"svClass": svClass, "svName": svName, "postDTO" : {title,"thumbnail": saveFileResponse.data,"status01": "0",shortdescription,content01,category }};
            console.log("api: " , api);
        ...
        const api = {"svClass": svClass, "svName": svName, "postDTO" : {title,"status01": "0","thumbnail": thumbnail,shortdescription,content01,category }};
        console.log("api: " , api);
        getAPI(api).then(getAPIResponse => {
            console.log("user: ", getAPIResponse.data);
            navigate(`/admin/posts`);
                ...
                <div className="row">
                    <div className="col-sm-12">
                        <div className="card">
                            ...
                            <div className="col-sm-9 text-secondary">
                                <input type="button" className="btn btn-primary px-2" value="Save"  style={{width: 60, marginTop: '40px', marginLeft:'60%'}}   onClick={() => handleChange()} />
                            </div>
