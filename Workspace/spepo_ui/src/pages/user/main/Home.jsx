                        ...
                        <div className="col-md-6 tn-right">
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="tn-img">
                                        <input type="image" src={require('../../../assets/img/home/top-news-2.jpg')} alt="" className='img' />
                                        <div className="tn-content">
                                            <div className="tn-content-inner">
                                                <a className="tn-date" href=""><i className="far fa-clock"></i>05-Feb-2020</a>
                                                <a className="tn-title" href="">Integer faucibus pharetra odio</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="tn-img">
                                        <input type="image" src={require('../../../assets/img/home/top-news-3.jpg')} alt="" className='img' />
                                        <div className="tn-content">
                                            <div className="tn-content-inner">
                                                <a className="tn-date" href=""><i className="far fa-clock"></i>05-Feb-2020</a>
                                                <a className="tn-title" href="">Nulla vitae pharetra ligula</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="tn-img">
                                        <input type="image" src={require('../../../assets/img/home/top-news-4.jpg')} alt="" className='img' />

                                        <div className="tn-content">
                                            <div className="tn-content-inner">
                                                <a className="tn-date" href=""><i className="far fa-clock"></i>05-Feb-2020</a>
                                                <a className="tn-title" href="">Ut ac euismod tellus a blandit</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="tn-img">
                                        <input type="image" src={require('../../../assets/img/home/top-news-5.jpg')} alt="" className='img' />
                                        <div className="tn-content">
                                            <div className="tn-content-inner">
                                                <a className="tn-date" href=""><i className="far fa-clock"></i>05-Feb-2020</a>
                                                <a className="tn-title" href="">Cras ac egestas sem nec euismod</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
